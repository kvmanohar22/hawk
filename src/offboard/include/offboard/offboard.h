...
public:
  ...
  bool engage_trajectory(mavros_msgs::CommandBool::Request& req, mavros_msgs::CommandBool::Response& res);

  /// set the current pose and plan the trajectory from the current pose
  bool set_curr_pose_planner(mavros_msgs::CommandBool::Request& req, mavros_msgs::CommandBool::Response& res);
  ...
  */
  ...
  bool MultiDOFJointTrajectory_to_posvel(const trajectory_msgs::MultiDOFJointTrajectoryConstPtr& src,
